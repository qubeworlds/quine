...
def main():
    ...
    scene = {
        ...
        # The city is the first scene to combine scene-level PNG textures, fog
        # and a 4096 shadow map — verified on webgl2 in-browser, but on WebGPU
        # (Safari 26 auto-picks it) the engine presents no frames for this
        # scene while the device stays alive (validation-failure profile).
        # Pin webgl2 until the WebGPU path is verified — same mechanism as the
        # drill scene. See docs/TODO.md.
