...
pub const spring = assets.spring;
pub const springVertexCount = assets.springVertexCount;
pub const springIndexCount = assets.springIndexCount;
...
pub const text = assets.text;
pub const textVertexCount = assets.textVertexCount;
pub const textIndexCount = assets.textIndexCount;
